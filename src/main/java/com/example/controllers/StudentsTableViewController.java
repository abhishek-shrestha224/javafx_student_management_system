...
public class StudentsTableViewController extends DashboardController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    // Load student data
    loadStudents();
    studentsTable.getStylesheets().add(getClass().getResource("/styles/app.css").toExternalForm());
  }

  private void loadStudents() {
    List<User> students = userDataController.getUsersByRole(Role.STUDENT);
  ...
  private void handleEdit(User workingUser) {
    try {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/students_edit_form.fxml"));
      Parent root = loader.load();

      StudentsEditFormController controller = loader.getController();
  ...
  private void handleAdd() {
    try {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/students_creation_form.fxml"));
      Parent root = loader.load();

      StudentsCreationFormController controller = loader.getController();
      controller.setUser(user);
